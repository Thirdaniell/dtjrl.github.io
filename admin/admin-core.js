...
const VIOLATIONS_DB = '3882ac472cd280a0a446d576c20fb20c';
...
const CONFLUENCE_GROUPS = [
  ...
  { label: 'Entry (PDA Arrays)', items: ['IFVG — Inverse Fair Value Gap','FVG — Fair Value Gap','First Presented FVG (9:30 AM Open)','OTE — Optimal Trade Entry','Rejection Block','Suspension Block','Order Block','Breaker Block','Mitigation Block','PDA Array'] },
  ...
  { label: 'Model', items: ['Market Maker Model','Power of 3','10 AM Reversal (Power of 3)','ATM Model (Asia Session)','Macro','Judas Swing','Kill Zone','RTH Gap','Octants','Quadrants','NWOG','NDOG','Asian Range','CISD — Change in State of Delivery','LRLR — Low Resistance Liquidity Run'] },
];
